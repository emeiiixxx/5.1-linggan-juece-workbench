...
<body>
  <main class="report">
    ...
    <section class="chapter chapter--white" id="chapter-02" data-chapter><div class="chapter-label">02 / PROJECT SCOPE</div><header class="section-head reveal"><h2>企划范围<br>与核心客群</h2><p>先锁定市场、客群、季节与渠道角色，再讨论视觉。所有未由任务输入或经营数据支持的内容，均作为待验证假设处理。</p></header><div class="scope-grid reveal"><article class="scope-card"><span>01 · MARKET</span><strong>${escapeHtml(market)}</strong><p>当前企划的销售与沟通市场。</p></article><article class="scope-card"><span>02 · AUDIENCE</span><strong>${escapeHtml(audience)}</strong><p>以实穿、易搭配和适度女性化为核心诉求。</p></article><article class="scope-card"><span>03 · SEASON</span><strong>${escapeHtml(season)}</strong><p>覆盖首发与补充验证波段。</p></article><article class="scope-card"><span>04 · CHANNEL</span><strong>${escapeHtml(channels)}</strong><p>搜索型成交与内容型验证并行。</p></article></div><div class="strategy-line reveal"><strong>企划命题</strong><p>将成熟花卉、克制女性化与过渡季层次转换为 ${escapeHtml(category)} 商品语言，在保证日常穿着门槛的同时，建立短视频首帧可识别的视觉钩子。</p></div></section>
    <section class="chapter" id="chapter-03" data-chapter><div class="chapter-label">03 / TREND EVIDENCE</div><header class="section-head reveal"><h2>趋势证据<br>与设计方向</h2><p>当前结论来自公开平台样本与任务中确认的视觉选择，不能直接替代销售、退货、毛利或消费者调研数据。</p></header><div class="direction-grid">${directionCards}</div></section>
    <section class="chapter chapter--dark" id="chapter-04" data-chapter><div class="chapter-label">04 / REFERENCES</div><header class="section-head reveal"><h2>灵感来源<br>图集</h2><p>保留最终确认图、方向标签与来源语境，确保后续设计、选款和对客沟通使用同一套视觉依据。</p></header><div class="gallery-grid">${gallery}</div></section>
    ...
    <section class="chapter chapter--white" id="chapter-08" data-chapter><div class="chapter-label">08 / KEY SILHOUETTES</div><header class="section-head reveal"><h2>关键廓形<br>造型</h2><p>宽松直身、柔性腰线与中长比例构成系列骨架；装饰集中在领口、袖口和局部抽褶，避免堆叠。</p></header><div class="silhouette-grid">${silhouetteCards}</div></section>
    ...
    <section class="chapter chapter--white" id="chapter-10" data-chapter><div class="chapter-label">10 / ASSORTMENT & PRICE</div><header class="section-head reveal"><h2>商品结构<br>与价格</h2><p>款数和价格基于当前任务输入形成建议梯度；缺少 OTB、毛利、历史销售与供应商报价，因此不应视为最终采购计划。</p></header><div class="metrics reveal">${summaryMetrics}</div><div class="assortment-table reveal">${assortmentRows}</div></section>
    <section class="chapter" id="chapter-11" data-chapter><div class="chapter-label">11 / LAUNCH & APPENDIX</div><header class="section-head reveal"><h2>上新策略<br>与附录</h2><p>以“小批量首发、跨渠道验证、数据复盘、补充波段”完成闭环，同时明确当前证据边界。</p></header><div class="launch-grid reveal"><article class="launch-card"><span>01 · PREPARE</span><h3>开发准备</h3><p>完成版型、工艺、报价、尺码与知识产权复核，锁定可测试 SKU。</p></article><article class="launch-card"><span>02 · LAUNCH</span><h3>双渠道首发</h3><p>Amazon 强化搜索与信息完整度；TikTok Shop 强化造型变化与首帧识别。</p></article><article class="launch-card"><span>03 · LEARN</span><h3>复盘与补充</h3><p>区分互动、点击、成交与退货信号，决定补单、改色、改版或停止。</p></article></div><div class="appendix reveal"><div><h3>待确认假设</h3><ul>${plan.assumptions.map((item) => `<li>${escapeHtml(item)}</li>`).join("")}</ul></div><div><h3>公开来源入口</h3><div class="source-list">${sourceRows}</div></div></div><footer class="footer"><span>${escapeHtml(directionLabel)}</span><span>WORKING DOCUMENT · 2026.08</span></footer></section>
  </main>
  <script>
    (function(){
