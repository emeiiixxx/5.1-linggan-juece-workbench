...
const copy: Record<string, Translation> = {
  ...
  "短款外套、衬衫、卫衣、短袖、长裤、短裤": {
    ja: "ショート丈アウター、シャツ、スウェット、半袖トップス、ロングパンツ、ショートパンツ",
  ...
  "以 Loro Piana 的 2027春夏 系列做为设计灵感，需要包含 短款外套、衬衫、卫衣、短袖、长裤、短裤 这些品类，生成一份 男装 主题设计企划": {
    ja: "Loro Pianaの2027年春夏コレクションを着想源に、ショート丈アウター、シャツ、スウェット、半袖トップス、ロングパンツ、ショートパンツを含むメンズ向けのテーマ企画を作成してください。",
    en: "Using Loro Piana's Spring/Summer 2027 collection as inspiration, create a men's theme plan covering short-length outerwear, shirts, sweatshirts, short-sleeve tops, trousers, and shorts.",
  },
  ...
  "描述主题企划的主题、目标和交付要求...": { ja: "テーマ企画のテーマ、目標、納品要件を入力...", en: "Describe the theme plan, goals, and deliverables..." },
