...
const copy: Record<string, Translation> = {
  ...
  "复制初始输入到新建任务": { ja: "最初の入力を新規タスクにコピー", en: "Copy Initial Prompt to New Task" },
  "返回顶部": { ja: "トップへ戻る", en: "Back to Top" },
  "业务偏好档案": { ja: "ビジネスプロファイル", en: "Business Profile" },
  "企业偏好档案": { ja: "ビジネスプロファイル", en: "Business Profile" },
  "项目": { ja: "プロジェクト", en: "Projects" },
  "任务": { ja: "タスク", en: "Tasks" },
  "最近": { ja: "最近", en: "Recent" },
  "暂无最近任务": { ja: "最近のタスクはありません", en: "No recent tasks" },
  ...
  "主题企划": { ja: "テーマ企画", en: "Theme Planning" },
  "短款外套、衬衫、卫衣、短袖、长裤、短裤": {
    ja: "ショートアウター、シャツ、スウェット、半袖、ロングパンツ、ショートパンツ",
    en: "Short-length outerwear, shirts, sweatshirts, short-sleeve tops, trousers, and shorts",
  },
  "以 Loro Piana 的 2027春夏 系列做为设计灵感，需要包含 短款外套、衬衫、卫衣、短袖、长裤、短裤 这些品类，生成一份 男装 主题设计企划": {
    ja: "Loro Pianaの2027年春夏を参考に、ショートアウター、シャツ、スウェット、半袖、ロングパンツ、ショートパンツを含むメンズ企画を作成してください。",
    en: "Create a menswear plan inspired by Loro Piana Spring/Summer 2027, including cropped outerwear, shirts, sweatshirts, short-sleeve tops, trousers, and shorts.",
  },
  "概览": { ja: "概要", en: "Overview" },
  "任务产物": { ja: "成果物", en: "Deliverables" },
  "参考款式": { ja: "参考スタイル", en: "Reference Styles" },
  "生成款式": { ja: "生成スタイル", en: "Generated Styles" },
  "改款提示词": { ja: "生成プロンプト", en: "Generation prompt" },
  ...
  "描述主题企划的主题、目标和交付要求...": { ja: "テーマやご希望を入力...", en: "Describe your theme and goals..." },
  ...
  "优质案例": { ja: "注目事例", en: "Featured Cases" },
  "优质案例列表": { ja: "注目事例一覧", en: "Featured cases list" },
  "查看只读案例": { ja: "閲覧専用の事例を見る", en: "View read-only case" },
  "向左查看更多案例": { ja: "左の事例をさらに表示", en: "Show more cases to the left" },
  "向右查看更多案例": { ja: "右の事例をさらに表示", en: "Show more cases to the right" },
  ...
  "视觉偏好": { ja: "ビジュアル設定", en: "Visual Preferences" },
  "描述偏好的色彩、廓形、面料、细节、模特、构图或需要避免的视觉表达;支持上传资料后自动回填": { ja: "好みの色、シルエット、素材、ディテール、モデル、構図、避けたい表現を入力してください。資料からの自動入力にも対応します。", en: "Describe preferred colors, silhouettes, fabrics, details, models, composition, or visuals to avoid; uploaded files can autofill this field." },
  "主题企划任务对话": { ja: "テーマ企画タスク", en: "Theme planning task" },
  "主题企划参考图片，支持多选": { ja: "テーマ企画の参考画像（複数選択可）", en: "Theme plan reference images, multiple selection supported" },
  "选择主题企划导出格式": { ja: "テーマ企画の出力形式を選択", en: "Select theme plan export format" },
  "主题企划任务概览": { ja: "テーマ企画タスクの概要", en: "Theme planning task overview" },
  "主题企划参考图片": { ja: "テーマ企画の参考画像", en: "Theme plan reference image" },
  "类PDF 2025，Kids主题企划": { ja: "PDF 2025風・キッズテーマ企画", en: "PDF-inspired 2025 Kids Theme Plan" },
  "类JACQUEMUS 2026，Women主题企划": { ja: "JACQUEMUS 2026風・ウィメンズテーマ企画", en: "JACQUEMUS-inspired 2026 Women Theme Plan" },
  "类DIOR 2026，Women主题企划": { ja: "DIOR 2026風・ウィメンズテーマ企画", en: "DIOR-inspired 2026 Women Theme Plan" },
  "轻奢度假 2027，Women主题企划": { ja: "2027ライトラグジュアリー・ウィメンズテーマ企画", en: "2027 Light Luxury Resort Women Theme Plan" },
  ...
  "输入渠道名称": { ja: "チャネル名を入力", en: "Enter channel name" },
  "输入渠道名称，按回车确认": { ja: "チャネル名を入力し、Enterで確定", en: "Enter a channel name and press Enter" },
  "输入品牌名称": { ja: "ブランド名を入力", en: "Enter brand name" },
  "输入品牌名称，按回车确认": { ja: "ブランド名を入力し、Enterで確定", en: "Enter a brand name and press Enter" },
  "重置": { ja: "リセット", en: "Reset" },
  ...
  "已识别可预填信息，正在回填表单": { ja: "自動入力できる情報を検出しました。フォームに反映しています。", en: "Autofill details found. Filling the form." },
