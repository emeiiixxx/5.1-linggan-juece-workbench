...
const ICON_ASSETS: Record<string, string> = {
  "apparel-design-menu": "apparel-design-menu.svg",
  "check-bold": "checkbox-check.svg",
  dot: "demand-dot.svg",
  "dislike-filled": "dislike-filled.svg",
...
const ART_INSETS: Record<string, string> = {
  ...
  "arrow-down-right": "25%",
  "arrow-up-right": "25%",
  "apparel-design-menu": "9.37% 2.67% 8.73% 6.25%",
  ...
  idea: "6.25% 18.75%",
  "image-generation": "12.5% 4.3% 11.76% 12.5%",
  like: "9.38% 10.36% 9.38% 9.38%",
  "like-filled": "9.38% 10.36% 9.38% 9.38%",
  dislike: "9.38% 9.37% 9.38% 10.36%",
  "dislike-filled": "9.38% 9.37% 9.38% 10.36%",
